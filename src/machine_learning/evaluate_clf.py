...
def confusion_matrix_and_report(X, y, pipeline, label_map):
    ...
    sns.heatmap(cm_df, annot=True, fmt='d', cmap='rocket_r',
                annot_kws={"size": 12}, linewidth=0.5, linecolor='grey')
    ...
    report = classification_report(y, y_pred, target_names=label_map, output_dict=True)
    ...
    # st.code(classification_report(y, y_pred, target_names=label_map), "\n")
