...
def page_predict_input_body():
    ...
    st.info(
        ...
        "The system provides three outputs for a live borrower:\n"
        "1. A **probability of default** based on the key inputs "
        ...
        "profiles (based on `person_home_ownership`, "
        "`cb_person_default_on_file` and `person_income`).\n"
        "3. A **business recommendation**, based on the probability of "
        "default and cluster assignment.\n\n"
        "The credit team can assess the repayment likelihood and also "
        "consider the borrower's cluster to understand broader risk "
        "characteristics.\n\n"
